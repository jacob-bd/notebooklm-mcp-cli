...
folders:
  ...
  tests: "Test suite"
  30_config: "Runtime and tool configuration"
...
executables:
  ...
  notebooklm-sync: "CLI for deterministic doc syncing with receipts and idempotence"

relates_to:
  - C001_mission-control: "Credential/secret handling and auth token services"
